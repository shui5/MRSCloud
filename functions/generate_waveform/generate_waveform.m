...
Bfield              = 2.89; % 3; 2.89;        % Philips magnetic field strength [Tesla]
gamma               = 42577000; % gyromagnetic ratio
F0                  = Bfield*gamma/1e6;
tp                  = 20; % duration of the editing pulse [ms]
fspan               = 1; %[kHz]
centreFreq          = 4.68;
dual_lobe           = [4.56,1.9]; % GSH/GABA
%dual_lobe           = [4.56,3.67]; % GSH/EtOH
%dual_lobe           = [3.67,1.9]; % GABA/EtOH
%dual_lobe           = [4.68,1.9]; % GABA/H2O

ac_avg              = mean(dual_lobe);
...
dl_split1   = abs(diff(dual_lobe))*Bfield*gamma/1e6;
% use parametrized look up to get the correct intended splitting and correct B1 for 100% inversion
...
io_writepta(editRF11,'dl_Siemens_univ_4_56_1_9_20ms.pta'); % uncomment this line to save .pta
