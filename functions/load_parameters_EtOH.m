function MRS_opt = load_parameters_EtOH(MRS_opt)
...
switch(vendor{1})
    ...
    case 'Siemens'
        ...
        if ~strcmp(MRS_opt.seq, 'UnEdited')
            ...
            elseif strcmp(MRS_opt.seq, 'HERMES')
                editWaveform1       = 'dl_Siemens_4_56_1_90.pta';  % name of 1st single editing pulse waveform. [4.56ppm]
                editWaveform2       = 'dl_Siemens_3_67_1_90_20ms.pta';  % name of 2nd single editing pulse waveform. [1.90ppm]
                editWaveform3       = 'dl_Siemens_3_67_4_56_20ms.pta';      % name of 1st dual editing pulse waveform. [4.56ppm 1.90ppm]
...
if strcmp(MRS_opt.seq, 'UnEdited')||strcmp(MRS_opt.seq, 'MEGA')||strcmp(MRS_opt.seq, 'HERMES')||strcmp(MRS_opt.seq, 'HERCULES')
    parfor X=1:length(MRS_opt.x)  %Use this if you do have the MATLAB parallel processing toolbox
