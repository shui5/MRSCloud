...
function RF=io_writelcmBASIS(in,outfile,vendor,SEQ,metablist,subspec)

metabList = fit_createMetabList({'default'});

% for cloud based simulation, scnh
% set user input to 1, scnh
name = fieldnames(metabList);
