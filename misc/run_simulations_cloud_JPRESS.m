function basis = run_simulations_cloud_JPRESS(json_input)
...
%% create basis set
%work_dir          = ('/Users/steve/Desktop/sim_ultrafast/Philips_MEGA_PRESS_TE68');
%work_dir          = ('/Users/steve/Desktop/sim_ultrafast/Philips_HERMES_PRESS');
...
for ss = 1:length(subspec)
    ...
    saveas(out,fullfile(save_dir,['basis_set' '_' subspecName{ss}]),'pdf');
    close;
end

%zipname = [work_dir,'mrs_sim_output','.zip'];
zipname = [work_dir,'TE',num2str(TE),'.zip'];
